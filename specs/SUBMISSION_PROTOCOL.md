...
> **Frozen subset** bundled on 2026-05-09T12:59:07Z.
...
3. **Submit via GitHub web UI** (auto-forks for non-collaborators):
   - Step 1: `https://github.com/local/local-art-collective/new/main/?filename=submissions/<slug>/meta.json&value=<urlencoded>`
   - Step 2: `https://github.com/local/local-art-collective/new/main/?filename=submissions/<slug>/piece.<ext>&value=<urlencoded>`
4. **Open an announcement Issue** (optional) at `https://github.com/local/local-art-collective/issues/new?labels=art-submission&title=art-piece:%20<slug>` — invites votes/comments.
