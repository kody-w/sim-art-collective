...
> Bundled at planting time on 2026-05-09T12:59:07Z. The authoritative source is the parent repo; this is the self-contained subset every planting needs.
...
For this neighborhood: `id` = `@local/local-art-collective`.
