...
> **Frozen subset** lifted from `kody-w/RAPP @ fb784f9 (post-Bond-Pulse)`. Bundled on 2026-05-09T12:59:07Z. These rules are LOCKED — breaking them is a regression. Append-only at the source.
